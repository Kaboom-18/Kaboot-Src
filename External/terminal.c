...
JNIEXPORT jint JNICALL Java_geq_kaboom_app_kaboot_terminal_termlib_JNI_createSubprocess(
        JNIEnv* env,
...
JNIEXPORT void JNICALL Java_geq_kaboom_app_kaboot_terminal_termlib_JNI_setPtyWindowSize(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fd, jint rows, jint cols, jint cell_width, jint cell_height)
{
...
JNIEXPORT jint JNICALL Java_geq_kaboom_app_kaboot_terminal_termlib_JNI_waitFor(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint pid)
{
    int status;
...
JNIEXPORT void JNICALL Java_geq_kaboom_app_kaboot_terminal_termlib_JNI_close(JNIEnv* TERMUX_UNUSED(env), jclass TERMUX_UNUSED(clazz), jint fileDescriptor)
{
